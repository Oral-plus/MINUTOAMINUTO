    ...
    try {
      ...
      try {
        sup = supervisores.firstWhere(
          (s) =>
              (s.nombre.toLowerCase().contains(nombre) ||
                  (s.alias != null && s.alias!.toLowerCase() == nombre)) &&
              s.codigo == codigo,
        );
      } catch (_) {}
      ...
      if (sup == null) {
        try {
          ven = vendedores.firstWhere(
            (v) =>
                (v.nombre.toLowerCase().contains(nombre) ||
                    (v.alias != null && v.alias!.toLowerCase() == nombre)) &&
                v.codigo == codigo,
          );
        } catch (_) {}
      }
      ...
      if (sup == null && ven == null) {
        if (mounted) {
          ...
          await ArtSweetAlert.show(
            ...
            content: Text(
              'No se encontró ningún usuario con ese nombre y código.\nVerifique sus datos o contacte al administrador.',
            ),
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: RadialGradient(
                    colors: [
                      context.ac.fg.withOpacity(0.035),
                      Colors.transparent,
                    ],
                  ),
                ),
            ...
            Positioned(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: RadialGradient(
                    colors: [
                      context.ac.fg.withOpacity(0.025),
                      Colors.transparent,
                    ],
                  ),
                ),
                      ...
                      ConstrainedBox(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                              color: context.ac.fg.withOpacity(0.09),
                            ),
                            boxShadow: [
                              BoxShadow(
            ...
            ? Center(
                child: SizedBox(
                  ...
                  child: CircularProgressIndicator(
                    strokeWidth: 2,
                    color: enabled
                        ? const Color(0xFF111827).withOpacity(0.54)
